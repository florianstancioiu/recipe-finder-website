...
- Search for recipes by name ~~or ingredients~~ (I initially implemented the search by ingredients feature but if I leave it implemented the filter functionality seems incorrect to regular users)
